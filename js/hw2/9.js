...
function isLoginUnique(allLogins, login) {
    ...
    // loginUnique ? return false : return true;
    if (loginUnique === true) {
        return false;
    }
    return true;
...
function addLogin(allLogins, login) {
    ...
    let message;
    // Write code under this line    
    // isLoginValid(login) ? message = ERROR : isLoginUnique(allLogins, login);
    // isLoginUnique(allLogins, login) ? message = REFUSAL : message = SUCCESS;
    // return message;
