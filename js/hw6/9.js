...
const users = [
  { name: 'Ross Vazquez', friends: ["coli", "met", "sem"] },
  { name: 'Ross', friends: ["colu", "met", "sem", "ki", "lo"] },
  { name: 'Vazquez', friends: ["colf", "met"] },
];
...
const getNamesSortedByFriendsCount = ([...array]) =>
  array.sort((a, b) => a.friends.length - b.friends.length).map(({ name }) => name);
